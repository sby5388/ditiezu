...
import com.by5388.ditiezu.databinding.FragmentArticleDetail2Binding;
 ...
 */
public class ArticleDetailFragment2 extends Fragment {
    ...
    private String mUrl;
    private FragmentArticleDetail2Binding mBinding;
    private CommentAdapter mAdapter;
    private DetailTool mTool;
    private Handler mHandler = new Handler();


    public static ArticleDetailFragment2 newInstance(String url) {
        final ArticleDetailFragment2 fragment = new ArticleDetailFragment2();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_article_detail2, container, false);
